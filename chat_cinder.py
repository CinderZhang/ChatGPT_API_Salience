'''
Code for the chatbot Cinder.
Must be run in Python 3.7 or higher.
Must update the key_openai.txt file with your OpenAI API key.
Must install the OpenAI Python library: pip install openai
